  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: 'url(https://tse2.mm.bing.net/th/id/OIP.4ANu2h5EqHSdqvxLDVrtwwHaE8?pid=Api&P=0&h=180)',
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(5,46,22,0.8) 0%, rgba(20,83,45,0.65) 50%, rgba(15,23,15,0.85) 100%)'
      }} />
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            <label style={{ display: 'block', color: 'rgba(255,255,255,0.5)', fontSize: '0.78rem', fontWeight: 600, marginBottom: '0.35rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Username</label>
        ...
        <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'rgba(255,255,255,0.4)', marginTop: '1.5rem' }}>
          ...
          <Link to="/login" style={{ color: '#86efac', textDecoration: 'none', fontWeight: 700, transition: 'color 0.2s' }}
